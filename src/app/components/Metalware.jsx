...
const Metalware = () => {
  const selectedData = companyData["metalware"];
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="flex flex-col lg:flex-row gap-4 w-full">
        ...
        {/* Company Details */}
        <div className="bg-white p-5 rounded-md shadow w-full lg:w-1/2 text-black">
          <h1 className="text-2xl font-bold mb-4 text-black">Company Details</h1>
          <p><span className="font-semibold  text-black">Name:</span> {selectedData.name}</p>
          <p><span className="font-semibold text-black">Address:</span> {selectedData.address}</p>
          <p><span className="font-semibold text-black">Contact:</span> {selectedData.contact}</p>
          <p><span className="font-semibold text-black">Current Version:</span> {selectedData.current_version}</p>
          <p className="mt-2">
            <span className="font-semibold text-black">Last Record Timestamp:</span> {lastRecordTimestamp}
          </p>
        </div>

        {/* Device Details */}
        <div className="bg-white p-5 rounded-md shadow w-full lg:w-1/2 text-black">
          <h1 className="text-2xl font-bold mb-4 text-black">Device Details</h1>
